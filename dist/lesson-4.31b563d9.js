...
var _symbolDefsSvgIconCross = require("./svg/symbol-defs.svg#icon-cross");
var _symbolDefsSvgIconCrossDefault = parcelHelpers.interopDefault(_symbolDefsSvgIconCross);
...
const marshals = [
    {
        ...
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Murat_%28Gerard%29.jpg/250px-Murat_%28Gerard%29.jpg'
    },
    {
        name: 'Jean Lannes',
        born: 'April 11, 1769',
        died: 'May 31, 1809',
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Jean_Charles_Nicaise_Perrin_-_Jean_Lannes%2C_duc_de_Montebello%2C_Mar%C3%A9chal_de_France.jpg/250px-Jean_Charles_Nicaise_Perrin_-_Jean_Lannes%2C_duc_de_Montebello%2C_Mar%C3%A9chal_de_France.jpg'
    },
    {
        ...
        <div class="modal">
            <button type="button" class="btn__close">
                <svg class="btn__close__svg">
                    <use href=${(0, _symbolDefsSvgIconCrossDefault.default)}></use>
                </svg>
            </button>
...
marshalsList.addEventListener('click', (event)=>{
    if (event.target.nodeName === 'BUTTON') createModal(0);
});

},{"basiclightbox":"io0Ts","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./svg/symbol-defs.svg#icon-cross":"3nnQ6"}],"io0Ts":[function(require,module,exports,__globalThis) {
!function(e) {
    module.exports = e();
}(function() {
...
},{}],"3nnQ6":[function() {},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire9e7c", {})

//# sourceMappingURL=lesson-4.31b563d9.js.map
